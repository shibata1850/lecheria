...
const REASONS = [
  {
    ...
    image: '/images/ChatGPT_Image_2026年5月1日_12_02_15.png',
  ...
  },
  {
    num: '02',
    title: '上質な空間',
    description: '完全個室で遠赤外線ドームを完備し、心身を温めながら、プライベート空間で一人一人のお悩みに合わせて施術効果を高めます。',
    image: '/images/IMG_7994.JPG',
    imageAlt: 'サロン完全個室・施術空間',
    brighten: false,
  },
  {
    num: '03',
    ...
    image: '/images/ChatGPT_Image_2026年5月1日_12_05_04.png',
    imageAlt: '美容機器施術',
    brighten: false,
  },
];
