...
const REASONS = [
  ...
  },
  {
    num: '03',
    title: '熟練ハンド技術×美容機器',
    description: 'キャリアある経験豊富なスタッフが、ハンド技術と先進美容機器を組み合わせて最適な施術をご提供。豊富なメニューからお悩みに合わせてご案内します。',
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-10">
          {REASONS.map((reason, index) => (
            ...
            >
              ...
              <div className="p-7">
                <span className="font-serif text-xl font-light text-silver tracking-widest block mb-3">{reason.num}</span>
