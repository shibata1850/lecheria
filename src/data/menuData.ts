...
export const MENU_CATEGORIES: MenuCategory[] = [
  ...
  },
  {
    ...
    image: '/images/%E8%84%B1%E6%AF%9B%20copy%20copy%20copy%20copy%20copy%20copy%20copy%20copy.png',
    priceFrom: '¥1,000〜',
    ...
    items: [
      { name: '顔脱毛（レディース）', price: '¥1,980' },
      {
        name: '髭脱毛＋美顔付き（メンズ）',
        price: '¥5,500',
        nameDetail: '美顔内容：東洋医学オールハンドフェイシャル（フェイス造美・フェイススリム）',
      },
  ...
  },
  {
    ...
    items: [
      { name: 'ラジオ波', duration: '30分', price: '¥3,980', nameDetail: '深部から温め、引き締め・たるみケアに' },
      { name: 'セルライトケア', duration: '30分', price: '¥3,980', nameDetail: 'セルライトに集中アプローチ' },
      { name: 'EMS', duration: '30分', price: '¥3,980', nameDetail: '筋肉へのアプローチで引き締め・くびれ形成' },
      { name: '全身カッピング', duration: '30分', price: '¥3,980', nameDetail: 'リンパと血流を促進するデトックスケア' },
