...
・人の生命・身体・財産の保護のために必要がある場合`,
  ...
  {
    title: 'Cookieの使用について',
    content: `当ウェブサイトでは、ウェブサイトの利便性向上のためにCookieを使用する場合があります。Cookieの使用により個人を特定することはありません。ブラウザの設定によりCookieを無効にすることが可能ですが、一部機能が制限される場合があります。`,
  },
  {
    title: '個人情報の開示・訂正・削除について',
    content: `お客様は、当サロンが保有するご自身の個人情報の開示・訂正・削除を請求することができます。ご請求の際は、下記お問い合わせ先までご連絡ください。`,
  },
  {
    title: 'プライバシーポリシーの変更について',
    content: `当サロンは、法令の変更やサービス内容の見直しなどにより、本プライバシーポリシーを予告なく変更する場合があります。変更後のポリシーは、本ウェブサイトに掲載した時点より効力を生じるものとします。`,
  },
  {
    title: 'お問い合わせ先',
      ...
      <section ref={ref as React.RefObject<HTMLElement>} className="bg-white py-20 md:py-28">
        <div className="max-w-3xl mx-auto px-6 md:px-10">
          <div className="fade-up mb-10">
            <p className="text-mid-gray text-xs font-sans">施行日：2026年3月1日</p>
            <p className="text-mid-gray text-xs font-sans">最終更新：2026年3月1日</p>
          </div>
