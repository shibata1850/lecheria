    ...
    <div className="min-h-screen bg-soft-gray flex items-center justify-center px-6">
      <div className="w-full max-w-sm">
        ...
        <form onSubmit={handleLogin} className="bg-white border border-border p-8 space-y-5">
          <div>
            <label className="block text-xs font-sans tracking-widest uppercase text-mid-gray mb-2">メールアドレス</label>
          ...
          <div>
            <label className="block text-xs font-sans tracking-widest uppercase text-mid-gray mb-2">パスワード</label>
